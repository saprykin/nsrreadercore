...
macro (NSR_TEST_LARGE_FILES VARIABLE)
	if ("${VARIABLE}" MATCHES "^${VARIABLE}$")
		...
		try_compile (FILE64_OK "${PROJECT_BINARY_DIR}" "${PROJECT_SOURCE_DIR}/cmake/TestFileOffsetBits.c")
		...
		if (FSEEKO_COMPILE_OK)
			set (NSR_HAVE_FSEEKO ON CACHE INTERNAL "Result of test for fseeko/ftello")
		else()
			message (STATUS "Checking for fseeko/ftello - not found")
			set (NSR_HAVE_FSEEKO OFF CACHE INTERNAL "Result of test for fseeko/ftello")
		endif()
